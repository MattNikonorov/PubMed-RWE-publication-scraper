...
for ki in range(len(keywords)):
    ...
    for year in range(2022, 2023):
        for month in range(1, 13):
                ...
                print(month)
                pmids = fetch.pmids_for_query(keyword+' '+str(year)+'/'+str(month)+'/01 [Date - Publication] : '+str(year)+'/'+str(month)+'/8 [Date - Publication] AND human NOT meta-analysis NOT systematic review NOT review NOT real-world NOT observational NOT retrospective NOT cohort NOT case-control NOT cross-sectional NOT electronic health records NOT registry NOT electronic health records NOT administrative data NOT epidemiological NOT population-based NOT administrative data NOT Pragmatic trial NOT Non-interventional',retmax=10000000)
                pm_var = f"{keyword} {str(year)}/{str(month)}/01 [Date - Publication] : {str(year)}/{str(month)}/8 [Date - Publication] AND human NOT meta-analysis NOT systematic review NOT review NOT real-world NOT observational NOT retrospective NOT cohort NOT case-control NOT cross-sectional NOT electronic health records NOT registry NOT electronic health records NOT administrative data NOT epidemiological NOT population-based NOT administrative data NOT Pragmatic trial NOT Non-interventional"
                print(pm_var)
                pmids2 = fetch.pmids_for_query(keyword+' '+str(year)+'/'+str(month)+'/9 [Date - Publication] : '+str(year)+'/'+str(month)+'/16 [Date - Publication] AND human NOT meta-analysis NOT systematic review NOT review NOT real-world NOT observational NOT retrospective NOT cohort NOT case-control NOT cross-sectional NOT electronic health records NOT registry NOT electronic health records NOT administrative data NOT epidemiological NOT population-based NOT administrative data NOT Pragmatic trial NOT Non-interventional',retmax=10000000)

                pmids3 = fetch.pmids_for_query(keyword+' '+str(year)+'/'+str(month)+'/17 [Date - Publication] : '+str(year)+'/'+str(month)+'/24 [Date - Publication] AND human NOT meta-analysis NOT systematic review NOT review NOT real-world NOT observational NOT retrospective NOT cohort NOT case-control NOT cross-sectional NOT electronic health records NOT registry NOT electronic health records NOT administrative data NOT epidemiological NOT population-based NOT administrative data NOT Pragmatic trial NOT Non-interventional',retmax=10000000)

                pmids4 = fetch.pmids_for_query(keyword+' '+str(year)+'/'+str(month)+'/25 [Date - Publication] : '+str(year)+'/'+str(month)+'/'+str(month_lengths[month_i])+' [Date - Publication] AND human NOT meta-analysis NOT systematic review NOT review NOT real-world NOT observational NOT retrospective NOT cohort NOT cross-sectional NOT case-control NOT electronic health records NOT registry NOT electronic health records NOT administrative data NOT epidemiological NOT population-based NOT administrative data NOT Pragmatic trial NOT Non-interventional',retmax=10000000)
