...
for ki in range(len(keywords)):
    ...
    for year in range(2022, 2024):
        for month in range(1, 13):
                ...
                print(month)
                pmids = fetch.pmids_for_query(keyword+' '+str(year)+'/'+str(month)+'/01[MDAT] : '+str(year)+'/'+str(month)+'/8[MDAT] AND human NOT meta-analysis NOT systematic review NOT review NOT real-world NOT observational NOT retrospective NOT cohort NOT case-control NOT cross-sectional NOT electronic health records NOT registry NOT electronic health records NOT administrative data NOT epidemiological NOT population-based NOT administrative data NOT claims database NOT Pragmatic trial',retmax=10000000)
