...
for ki in range(len(keywords)):
    ...
    for year in range(2022, 2024):
        for month in range(8, 10):
                ...
                print(month)
                pmids = fetch.pmids_for_query(keyword+' '+str(year)+'/'+str(month)+'/01[MDAT] : '+str(year)+'/'+str(month)+'/8[MDAT] AND human NOT meta-analysis NOT systematic review NOT review NOT real-world NOT observational NOT administrative data NOT cohort NOT case-control NOT cross-sectional NOT electronic health records NOT population-based NOT registry NOT electronic health records NOT administrative data NOT claims database NOT epidemiological NOT Pragmatic trial NOT Non-interventional',retmax=10000000)
