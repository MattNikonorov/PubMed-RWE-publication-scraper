...
keywords = ["real-world", "observational", "retrospective", "prospective", "cohort", "case-control", "cross-sectional", "longitudinal", "population-based", "epidemiological", "registry", "electronic health records", "administrative data", "claims database"]
...
for ki in range(len(keywords)):
                ...
                pmids_tot = fetch1.pmids_for_query(keyword, retmax=100)
                ...
                if 1 > 0:
                    ...
                    df_merged.to_csv(f"scraped_files2/{keyword}.csv")
